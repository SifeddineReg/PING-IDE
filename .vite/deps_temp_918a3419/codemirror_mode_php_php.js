import {
  require_htmlmixed
} from "./chunk-SULN2QBK.js";
import {
  require_clike
} from "./chunk-XXJLUDNX.js";
import "./chunk-IMXC6RCN.js";
import "./chunk-V5ORE4GR.js";
import "./chunk-NECNLM6J.js";
import {
  require_codemirror
        ...
        function dispatch(stream, state) {
          ...
          if (!isPHP) {
            if (stream.match(/^<\?\w*/)) {
              ...
              if (!state.php) state.php = CodeMirror2.startState(phpMode, htmlMode.indent(state.html, "", ""));
